...
var app = (function () {
    ...
    const file$4 = "src\\pages\\main.svelte";

    // (17:6) <Link to="projects">
    function create_default_slot_1$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "card svelte-gth55f");
    			add_location(div, file$4, 17, 8, 523);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_default_slot$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "card svelte-gth55f");
    			add_location(div, file$4, 20, 8, 605);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t7 = text("Created by Me ❤️ with ");
    			span = element("span");
    			span.textContent = "Svelte";
    			attr_dev(h1, "class", "svelte-gth55f");
    			add_location(h1, file$4, 9, 4, 277);
    			attr_dev(div0, "class", "icons svelte-gth55f");
    			add_location(div0, file$4, 10, 4, 340);
    			attr_dev(div1, "class", "cards svelte-gth55f");
    			add_location(div1, file$4, 15, 4, 466);
    			attr_dev(span, "class", "svelte-gth55f");
    			add_location(span, file$4, 27, 34, 858);
    			attr_dev(footer, "class", "svelte-gth55f");
    			add_location(footer, file$4, 27, 4, 828);
    			attr_dev(main, "class", "svelte-gth55f");
    			add_location(main, file$4, 8, 2, 265);
    			attr_dev(div2, "class", "container svelte-gth55f");
    			add_location(div2, file$4, 7, 0, 238);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Link, faCog, faGithub, faLinkedin, Fa });
    	return [];
    }
    ...
    /* src\components\navbar.svelte generated by Svelte v3.35.0 */
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "NavBar svelte-fiicby");
    ...
    function create_default_slot_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "project svelte-2hwcit");
    			add_location(div, file$2, 11, 8, 256);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			div.textContent = "Project 22";
    			attr_dev(div, "class", "project svelte-2hwcit");
    			add_location(div, file$2, 14, 8, 342);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_default_slot_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			div.textContent = "Project 3";
    			attr_dev(div, "class", "project svelte-2hwcit");
    			add_location(div, file$2, 17, 8, 429);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			div.textContent = "Project 4";
    			attr_dev(div, "class", "project svelte-2hwcit");
    			add_location(div, file$2, 20, 8, 515);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			span = element("span");
    			span.textContent = "Svelte";
    			attr_dev(h1, "class", "svelte-2hwcit");
    			add_location(h1, file$2, 8, 4, 173);
    			attr_dev(div0, "class", "projects svelte-2hwcit");
    			add_location(div0, file$2, 9, 4, 196);
    			attr_dev(span, "class", "svelte-2hwcit");
    			add_location(span, file$2, 23, 34, 614);
    			attr_dev(footer, "class", "svelte-2hwcit");
    			add_location(footer, file$2, 23, 4, 584);
    			attr_dev(main, "class", "svelte-2hwcit");
    			add_location(main, file$2, 7, 2, 161);
    			attr_dev(div1, "class", "container svelte-2hwcit");
    			add_location(div1, file$2, 5, 0, 120);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Link, NavBar: Navbar });
    	return [];
    }
    ...
    /* src\pages\notFound.svelte generated by Svelte v3.35.0 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h10, "class", "svelte-154v6zu");
    			add_location(h10, file$1, 9, 6, 186);
    			attr_dev(h11, "class", "svelte-154v6zu");
    			add_location(h11, file$1, 10, 6, 206);
    			attr_dev(div0, "class", "svelte-154v6zu");
    			add_location(div0, file$1, 8, 4, 173);
    			attr_dev(main, "class", "svelte-154v6zu");
    			add_location(main, file$1, 7, 2, 161);
    			attr_dev(div1, "class", "container svelte-154v6zu");
    			add_location(div1, file$1, 5, 0, 120);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_default_slot(ctx) {
    	...
    	route2 = new Route({
    			props: { path: "/", exact: true, component: Main },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-atf2mg");
    			add_location(div, file, 8, 2, 233);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Router, Route, Main, Projects, NotFound });
    	return [];
    }
