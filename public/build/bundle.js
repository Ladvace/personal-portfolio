...
var app = (function () {
    ...
    /* src\pages\main.svelte generated by Svelte v3.35.0 */
    ...
    function create_fragment$1(ctx) {
    	...
    	let span;
    	let current;
    	fa0 = new Fa({ props: { icon: faCog }, $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "Hi!✋ I'm Gianmarco a Front End 💻 based in Italy";
    			t1 = space();
    			div0 = element("div");
    			...
    			t17 = text("Created by Me ❤️ with ");
    			span = element("span");
    			span.textContent = "Svelte";
    			attr_dev(h1, "class", "svelte-1nxtpi7");
    			add_location(h1, file$1, 8, 4, 233);
    			attr_dev(div0, "class", "icons svelte-1nxtpi7");
    			add_location(div0, file$1, 9, 4, 296);
    			attr_dev(div1, "class", "card svelte-1nxtpi7");
    			add_location(div1, file$1, 15, 6, 449);
    			attr_dev(div2, "class", "card svelte-1nxtpi7");
    			add_location(div2, file$1, 16, 6, 484);
    			attr_dev(div3, "class", "card svelte-1nxtpi7");
    			add_location(div3, file$1, 17, 6, 519);
    			attr_dev(div4, "class", "card svelte-1nxtpi7");
    			add_location(div4, file$1, 18, 6, 556);
    			attr_dev(div5, "class", "card svelte-1nxtpi7");
    			add_location(div5, file$1, 19, 6, 592);
    			attr_dev(div6, "class", "card svelte-1nxtpi7");
    			add_location(div6, file$1, 20, 6, 628);
    			attr_dev(div7, "class", "cards svelte-1nxtpi7");
    			add_location(div7, file$1, 14, 4, 422);
    			attr_dev(span, "class", "svelte-1nxtpi7");
    			add_location(span, file$1, 22, 34, 703);
    			attr_dev(footer, "class", "svelte-1nxtpi7");
    			add_location(footer, file$1, 22, 4, 673);
    			attr_dev(main, "class", "svelte-1nxtpi7");
    			add_location(main, file$1, 7, 2, 221);
    			attr_dev(div8, "class", "container svelte-1nxtpi7");
    			add_location(div8, file$1, 6, 0, 194);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ faCog, faGithub, faLinkedin, Fa });
    	return [];
    }
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-cc9qyi");
    			add_location(main, file, 6, 2, 131);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Router, Route, Link, Main });
    	return [];
    }
